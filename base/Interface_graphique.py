...
def get_resource_path(relative_path):
    """ Gère les chemins des ressources lors de l'exécution dans un .exe """
    try:
        # Si l'application est compilée
        base_path = sys._MEIPASS
    except Exception:
        # En mode développement, utilise le chemin absolu
...
class Interface_graphique:
    ...
    def __init__(self, jeu):
        ...
        self.fenetre.iconbitmap(get_resource_path("ressources/images/logo_lemming_game.ico"))
        ...
        image_accueil = Image.open(get_resource_path("ressources/images/logo_lemming_game.png"))
        ...
        self.image_droite_base = Image.open(get_resource_path("ressources/images/lemming_image__droite.png"))
        self.image_gauche_base = Image.open(get_resource_path("ressources/images/lemming_image_gauche.png"))
    ...
    def lancer_jeu(self):
            ...
            if pygame_available and not self.mute: pygame.mixer.Sound.play(pygame.mixer.Sound(get_resource_path("ressources/musique/goofy-slip.mp3")))
    ...
    def ajouter_lemming(self):
        if pygame_available and not self.mute:pygame.mixer.Sound.play(pygame.mixer.Sound(get_resource_path("ressources/musique/spawn.mp3")))
    ...
    def effectuer_tour(self):
        if pygame_available and not self.mute:pygame.mixer.Sound.play(pygame.mixer.Sound(get_resource_path("ressources/musique/pop.mp3")))
        self.jeu.tour()
        self.actualiser_affichage()
